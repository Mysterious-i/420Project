...
int setup(int width, int height,
    ...
    XParseColor(*display, colormap, user_color, &new_col);
    XAllocColor(*display, colormap, &new_col);
    ...
    *gc = XCreateGC (*display, *win, valuemask, &values); /* graphics context */
     ...
     */
    //*min_color = (white > black) ? white: black;
    //*max_color = (white > black) ? black : white;
    *max_color = black;
    *min_color = new_col.pixel;
